...
$('.note-header').keydown(function(e){
    
});

function cancelEnter(e) {
    console.log(e.keyCode)
    //if(e.returnKey && (e.which == 13))
        //e.preventDefault();
}
...
$('.save').click(function(){
    if(validateInputs()) {
        ...
        $('.toggle').addClass('mdi-plus');
        $('.note-body').slideUp('fast');
        var note = '<div class="note" data-id="'+getDateNow()+'" data-width="250" data-flag="false" onmouseover="noteMouseOver(this)" onmouseleave="noteMouseLeave(this)">'+
        ...
        $(".note-title" ).keydown(function(evt) {
...
function getDateNow() {
    ...
    dataagora = hora + minuto + segundo + dia + mes + ano;
